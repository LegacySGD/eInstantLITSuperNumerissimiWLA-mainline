...
public class LITSuperNumerissimiWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITSuperNumerissimiWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITSuperNumerissimiWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITSuperNumerissimiWLAIW/InitOutcome.xml").getDocumentElement();
